  ...
  return (
    ...
    >
      <div className="flex   w-full h-auto  justify-center ">
        <div className="flex bg-black bg-opacity-50 py-12 justify-center mx-auto px-0 lg:justify-start lg:px-0 md:justify-start md:px-0 xl:justify-start xl:px-14 xl:py-0">
