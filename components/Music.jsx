  ...
  return (
    ...
    >
      <div className="w-full">
        <div className="flex justify-end w-full bg-fit bg-center bg-musicBGI bg-contain bg-fixed md:bg-contain xl:bg-contain lg:w-[893px] lg:bg-fixed lg:bg-fit lg:bg-contain lg:h-[893px] xl:w-[893px] xl:h-[893px] xl:min-h-[980px] xl:flex h-96 mx-auto bg-no-repeat  "></div>
      </div>
