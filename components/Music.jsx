  ...
  return (
    ...
    >
      <div className="w-full">
        <div className="flex justify-center w-full bg-musicBGI h-[90vh] bg-fit bg-contain bg-scroll 2xl:bg-fixed xl:bg-fixed lg:bg-fixed md:bg-fixed mx-auto bg-no-repeat "></div>
      </div>
